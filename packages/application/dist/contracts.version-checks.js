...
const _membershipSaveHasVersion = false;
const _roleSaveHasVersion = true;
const _websiteSaveHasVersion = false;
...
const _membershipSaveRequiresId = false;
const _roleSaveRequiresId = true;
const _websiteSaveRequiresId = false;

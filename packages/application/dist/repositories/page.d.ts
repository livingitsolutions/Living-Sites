import type { Page, PageSnapshot, PageStatus, PageId, WebsiteId, PaginatedResult, PaginationParams, AggregateVersion } from "@livingsites/domain";
...
export interface PageSnapshotRepository {
    ...
    create(snapshot: Omit<PageSnapshot, "id"> & {
        id?: string;
    }): Promise<CreateResult<PageSnapshot>>;
}

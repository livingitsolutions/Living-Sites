 ...
 */
import type { Result, DomainError, WebsiteId, PageId, SectionId, Page, Section, BuilderCanvas, RenderedPage } from "@livingsites/domain";
export interface BuilderService {
    ...
    updateSection(sectionId: SectionId, props: Record<string, unknown>): Promise<Result<Section, DomainError>>;
    removeSection(sectionId: SectionId): Promise<Result<Page, DomainError>>;
    moveSection(sectionId: SectionId, target: {
        pageId: PageId;
        insertAfterSectionId?: SectionId | null;
    }): Promise<Result<{
        page: Page;
...
//# sourceMappingURL=cross-context.d.ts.map
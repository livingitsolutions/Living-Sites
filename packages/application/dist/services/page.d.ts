import type { Page, PageSnapshot, PageId, WebsiteId, SectionId, Result, DomainError } from "@livingsites/domain";
export interface PageService {
    ...
    updateContent(pageId: PageId, changes: {
        title?: string;
        description?: string;
    ...
    publish(pageId: PageId): Promise<Result<{
        page: Page;

import type { SEOProfile, SchemaProfile, SitemapEntry, WebsiteId, PageId, Result, DomainError } from "@livingsites/domain";
...
export interface SEOService {
    upsertPageProfile(pageId: PageId, profile: Omit<SEOProfile, "id" | "websiteId" | "pageId" | "audit">): Promise<Result<SEOProfile, DomainError>>;
    upsertWebsiteDefaults(websiteId: WebsiteId, profile: Omit<SEOProfile, "id" | "websiteId" | "pageId" | "audit">): Promise<Result<SEOProfile, DomainError>>;

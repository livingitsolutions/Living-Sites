...
import { InMemoryUserRepository, FakeAuthenticationAdapter, InMemoryEventPublisher, FakeClock, DeterministicIdGenerator, } from "@livingsites/test-support";
describe("registerUser use case", () => {
    ...
    it("Platform User failure triggers compensation", async () => {
        // Pre-populate with the same auth subject ID to cause a duplicate
        // This simulates a failure in user creation
        ...
        // Second registration with same email - should fail with duplicate
        const result = await registerUser({
            email: "first@test.com",
            password: "very-secure-password-123",
            displayName: "Second",
...
//# sourceMappingURL=use-case.test.js.map
...
export declare function restorePage(input: {
    ...
    code: "unauthorized" | "website_not_found" | "not_found" | "invalid_lifecycle" | "duplicate_slug" | "concurrency_conflict" | "persistence_error";
    message: string;
}>>;
//# sourceMappingURL=restore-page.d.ts.map
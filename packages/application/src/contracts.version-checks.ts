...
const _membershipHasSave: HasSave<MembershipRepository> = false;
...
const _websiteHasSave: HasSave<WebsiteRepository> = false;
...
const _membershipSaveHasVersion: SaveHasExpectedVersion<MembershipRepository> = false;
const _roleSaveHasVersion: SaveHasExpectedVersion<RoleRepository> = true;
const _websiteSaveHasVersion: SaveHasExpectedVersion<WebsiteRepository> = false;
...
const _membershipSaveRequiresId: SaveRequiresId<MembershipRepository> = false;
const _roleSaveRequiresId: SaveRequiresId<RoleRepository> = true;
const _websiteSaveRequiresId: SaveRequiresId<WebsiteRepository> = false;
...
export {
  ...
  _themeCreateNoVersion, _sectionTypeCreateNoVersion, _mediaCreateNoVersion,
  ...
  _themeSaveHasVersion, _sectionTypeSaveHasVersion, _mediaSaveHasVersion,
  ...
  _themeSaveRequiresId, _sectionTypeSaveRequiresId, _mediaSaveRequiresId,

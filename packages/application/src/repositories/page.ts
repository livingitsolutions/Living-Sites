...
export interface PageMutationPersistence {
  saveBuilder(input: { readonly pageId: PageId; readonly sections: readonly Section[]; readonly expectedVersion: AggregateVersion; readonly updatedAt: string; readonly updatedBy: string }): Promise<SaveResult<Page>>;

...
export function validatePassword(password: string): { ok: true } | { ok: false; error: { code: "weak_password"; message: string } } {
...
export function validateDisplayName(displayName: string): { ok: true } | { ok: false; error: { code: "input_validation"; message: string; field: "displayName"; value: string } } {

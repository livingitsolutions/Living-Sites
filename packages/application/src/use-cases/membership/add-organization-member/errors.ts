...
export type AddOrganizationMemberError =
  ...
  | { readonly code: "user_not_found"; readonly message: string; readonly userId: string }
  | { readonly code: "duplicate_membership"; readonly message: string; readonly userId: string }
  | DuplicateKeyError

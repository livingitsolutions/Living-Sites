...
const FEATURE_SEEDS = [
    { id: FEATURE_IDS.websiteLimit, key: "website_limit", category: "limit", name: "Website Limit", description: "Maximum number of websites", value_type: "number", is_active: true, version: 1 },
    { id: FEATURE_IDS.customDomain, key: "custom_domain", category: "capability", name: "Custom Domain", description: "Allow custom domain publishing", value_type: "boolean", is_active: true, version: 1 },
    { id: FEATURE_IDS.exportAccess, key: "export_access", category: "capability", name: "Export Access", description: "Access to data export", value_type: "boolean", is_active: true, version: 1 },
    { id: FEATURE_IDS.pageBuilder, key: "page_builder", category: "capability", name: "Page Builder", description: "Access to the page builder", value_type: "boolean", is_active: true, version: 1 },
    { id: FEATURE_IDS.formsAccess, key: "forms_access", category: "capability", name: "Forms", description: "Access to forms", value_type: "boolean", is_active: true, version: 1 },
    { id: FEATURE_IDS.seoAccess, key: "seo_access", category: "capability", name: "SEO", description: "Access to SEO tools", value_type: "boolean", is_active: true, version: 1 },
    { id: FEATURE_IDS.analyticsAccess, key: "analytics_access", category: "capability", name: "Analytics", description: "Access to analytics", value_type: "boolean", is_active: true, version: 1 },
];
...
export async function seedPlansAndFeatures(db) {
    let plansInserted = 0;
